<?php /* Smarty version Smarty-3.1.18, created on 2015-01-28 21:32:11
         compiled from ".\application\views\templates\admin\orders.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2323654c94093781291-00466393%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e0860ce1a2424b46897aa25f72cddfbc10e64c04' => 
    array (
      0 => '.\\application\\views\\templates\\admin\\orders.tpl',
      1 => 1422477129,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2323654c94093781291-00466393',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_54c94094664360_31559065',
  'variables' => 
  array (
    'user' => 0,
    'menus' => 0,
...
<?php if ($_valid && !is_callable('content_54c94094664360_31559065')) {function content_54c94094664360_31559065($_smarty_tpl) {?><!doctype html>
<html lang="en"><head>
    <meta charset="utf-8">
    <title>KIS</title>
...
?>
            <tr>
                <td class="tg-s6z2" style="width: 20%;">
                    <?php echo $_smarty_tpl->tpl_vars['order']->value->getIdOrder();?>

                </td>
                <td class="tg-s6z2">
                    <span class="td-table"><?php echo $_smarty_tpl->tpl_vars['order']->value->getCustomer()->getNameCustomer();?>
</span>
                </td>
                <td class="tg-s6z2">
                    <span class="td-table"><?php echo $_smarty_tpl->tpl_vars['order']->value->getProduct()->getName();?>
</span>
                </td>
                <td class="tg-s6z2">
                    <span class="td-table"><?php echo $_smarty_tpl->tpl_vars['order']->value->getCount();?>
</span>
                </td>
                <td class="tg-s6z2">
                    <span class="td-table"><?php echo $_smarty_tpl->tpl_vars['order']->value->getRegistrationDate()->format('Y-m-d H:i:s');?>
</span>
                </td>
                <td class="tg-s6z2">
                    <span class="td-table"><?php echo $_smarty_tpl->tpl_vars['order']->value->getExecutionDate()->format('Y-m-d H:i:s');?>
</span>
                </td>
                <td class="tg-s6z2">
                    <span class="td-table"><?php echo $_smarty_tpl->tpl_vars['order']->value->getPaid();?>
 грн</span>
                </td>
            </tr>
        <?php } ?>
