<?php /* Smarty version Smarty-3.1.18, created on 2015-01-29 17:07:37
         compiled from ".\application\views\templates\industrial\form-need-raw.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2176954ca59243391b9-84580137%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c9ebe9c0af70c907efc32195f1f5e74833c6e57d' => 
    array (
      0 => '.\\application\\views\\templates\\industrial\\form-need-raw.tpl',
      1 => 1422547655,
      2 => 'file',
    ),
    'd86748aafb981c8089aa010dd5bf3f2a835c8642' => 
    array (
      0 => '.\\application\\views\\templates\\industrial\\need-raw.tpl',
      1 => 1422547370,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2176954ca59243391b9-84580137',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_54ca59250c07b1_58668714',
  'variables' => 
  array (
    'user' => 0,
    'menus' => 0,
...
<?php if ($_valid && !is_callable('content_54ca59250c07b1_58668714')) {function content_54ca59250c07b1_58668714($_smarty_tpl) {?><!doctype html>
<html lang="en"><head>
    <meta charset="utf-8">
    <title>KIS</title>
...
"><?php echo $_smarty_tpl->tpl_vars['product']->value->getName();?>
        ...
        <select name='raw'>
            <?php  $_smarty_tpl->tpl_vars['raw'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['raw']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['raws']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['raw']->key => $_smarty_tpl->tpl_vars['raw']->value) {
$_smarty_tpl->tpl_vars['raw']->_loop = true;
?>
                <option value="<?php echo $_smarty_tpl->tpl_vars['raw']->value->getIdRaw();?>
"><?php echo $_smarty_tpl->tpl_vars['raw']->value->getName();?>
</option>
            <?php } ?>
        </select>
    ...
    <table class="tg">
        ...
        <?php  $_smarty_tpl->tpl_vars['needRaw'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['needRaw']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['needRaws']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['needRaw']->key => $_smarty_tpl->tpl_vars['needRaw']->value) {
$_smarty_tpl->tpl_vars['needRaw']->_loop = true;
?>
            <tr>
                <td class="tg-s6z2" style="width: 20%;">
                    <?php echo $_smarty_tpl->tpl_vars['needRaw']->value->getIdNeedraw();?>

                </td>
                <td class="tg-s6z2">
                    <span class="td-table"><?php echo $_smarty_tpl->tpl_vars['needRaw']->value->getProduct()->getName();?>
</span>
                </td>
                <td class="tg-s6z2">
                    <span class="td-table"><?php echo $_smarty_tpl->tpl_vars['needRaw']->value->getRaw()->getName();?>
</span>
                </td>
                <td class="tg-s6z2">
                    <span class="td-table"><?php echo $_smarty_tpl->tpl_vars['needRaw']->value->getAmountRaw();?>
 кг</span>
                </td>
            </tr>
        <?php } ?>
